...
object DateUtils {
    ...
    fun Date.getMediumDateFormat(context: Context): String =
        getFormattedDate(DATE_FORMAT)

    fun Date.getFormattedDate(format: String, timeZone: TimeZone = TimeZone.getDefault()): String =
