...
class KMS_ContentType(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return KMS_ContentTypeViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: KMS_ContentTypeViewHolder =
            holder as KMS_ContentTypeViewHolder
    ...
    class KMS_ContentTypeViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                KMSearchRepositoryFragment.cboContentType!!.text = items.sName
                KMSearchRepositoryFragment.iContentTypeID = items.id
