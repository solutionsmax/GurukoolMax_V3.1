...
import com.solutionsmax.gurukoolmax_v3.databinding.FragmentReviewLearningSessionListBinding
...
class ReviewLearningSessionListFragment : BaseFragment() {
    private lateinit var binding: FragmentReviewLearningSessionListBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentReviewLearningSessionListBinding.inflate(inflater)
        return binding.root
    }
            ...
            with(setupLearningSessionViewModel) {
                ...
                retrieveLearningSessionListMutableData.observe(viewLifecycleOwner) {
                    with(binding.scholasticGradeList) {
                        ...
                        adapter = ReviewLearningSessionAdapter(it)
                    }
                }
            }
        }
    ...
    private fun postErrors(event: Event<Failure>) {
        errorLogsViewModel.postErrorLogs(
            ...
            postErrorLogsItems = PostErrorLogsItems(
                ...
                iReviewStatusID = -1,
                sErrorSource = ReviewLearningSessionListFragment::class.simpleName.toString(),
