...
class CCEBoard(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return CCEBoardViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: CCEBoardViewHolder =
            holder as CCEBoardViewHolder
    ...
    class CCEBoardViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                CceScholasticInfoFragment.cboAcademicBoard!!.text = items.sName
                CceScholasticInfoFragment.iBoardID = items.id
