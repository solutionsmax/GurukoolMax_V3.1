...
class ExamSetupFocusAssignment(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return ExamSetupFocusAssignmentViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: ExamSetupFocusAssignmentViewHolder =
            holder as ExamSetupFocusAssignmentViewHolder
    ...
    class ExamSetupFocusAssignmentViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                ExaminationSetupInfoFragment.cboFocusAssignment!!.text = items.sName
                ExaminationSetupInfoFragment.iFocusAssignmentID = items.id
