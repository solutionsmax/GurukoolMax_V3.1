...
class KM_FormatTypes(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return KM_FormatTypesViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: KM_FormatTypesViewHolder =
            holder as KM_FormatTypesViewHolder
    ...
    class KM_FormatTypesViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                KMPostRepositoryInfoFragment.cboSubmissionFormat!!.text = items.sName
                KMPostRepositoryInfoFragment.iSubmissionFormatID = items.id
