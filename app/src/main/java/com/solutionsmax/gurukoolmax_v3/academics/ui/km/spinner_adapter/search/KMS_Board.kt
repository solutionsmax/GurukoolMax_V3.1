...
class KMS_Board(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return KMS_BoardViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: KMS_BoardViewHolder =
            holder as KMS_BoardViewHolder
    ...
    class KMS_BoardViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                KMSearchRepositoryFragment.cboBoard!!.text = items.sName
                KMSearchRepositoryFragment.iAcademicBoardID = items.id
