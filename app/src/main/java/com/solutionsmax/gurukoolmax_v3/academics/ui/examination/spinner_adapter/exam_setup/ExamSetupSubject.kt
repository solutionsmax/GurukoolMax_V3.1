...
class ExamSetupSubject(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return ExamSetupSubjectViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: ExamSetupSubjectViewHolder =
            holder as ExamSetupSubjectViewHolder
    ...
    class ExamSetupSubjectViewHolder(
        ...
        fun bind(items: PopulateSubjectList, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                ExaminationSetupInfoFragment.cboSubject!!.text = items.sSubjectName
                ExaminationSetupInfoFragment.iSubjectID = items.iSubjectID
