...
class AP_Board(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return AP_BoardViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: AP_BoardViewHolder =
            holder as AP_BoardViewHolder
    ...
    class AP_BoardViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                ProjectSubmissionInfoFragment.cboBoard!!.text = items.sName
                ProjectSubmissionInfoFragment.iAcademicBoard = items.id
