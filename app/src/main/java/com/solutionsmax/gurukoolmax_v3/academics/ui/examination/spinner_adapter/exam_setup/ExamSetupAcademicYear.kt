...
class ExamSetupAcademicYear(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return ExamSetupAcademicYearViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: ExamSetupAcademicYearViewHolder =
            holder as ExamSetupAcademicYearViewHolder
    ...
    class ExamSetupAcademicYearViewHolder(
        ...
        fun bind(items: PopulateMasterListItem, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                ExaminationSetupInfoFragment.cboAcademicYear!!.text = items.sName
                ExaminationSetupInfoFragment.iAcademicYearID = items.id
