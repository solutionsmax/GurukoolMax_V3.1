...
class AP_Class(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return AP_ClassViewHolder(layout)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val rfManufactureYearHolder: AP_ClassViewHolder =
            holder as AP_ClassViewHolder
    ...
    class AP_ClassViewHolder(
        ...
        fun bind(items: PopulateClassItems, clickListener: OnItemClick) {
            ...
            binding.lblSpinnerItem.setOnClickListener {
                ...
                ProjectSubmissionInfoFragment.cboClass!!.text = items.sClassStandard
                ProjectSubmissionInfoFragment.iClassID = items.iClassStandardID
                ProjectSubmissionInfoFragment.dialog!!.dismiss()
            }
        }
    }
